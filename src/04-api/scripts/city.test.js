...
test("check show method", () => {
  const city = new City(1, "Calgary", 51.0447, "114.0719 W", 1285711);
...
test("check howBig method", () => {
  const city1 = new City(1, "Calgary", 51.0447, "114.0719 W", 1285711);
  expect(city1.howBig()).toBe("City - a population > 100,000");

  const city2 = new City(2, "Hamlet", 51.0447, "114.0719 W", 99);
  expect(city2.howBig()).toBe("Hamlet - population 1 - 100");

  const city3 = new City(3, "Village", 51.0447, "114.0719 W", 500);
  expect(city3.howBig()).toBe(
    "Village - larger than a hamlet but smaller than a town"
  );

  const city4 = new City(4, "Town", 51.0447, "114.0719 W", 18000);
  expect(city4.howBig()).toBe(
    "Town - a town has a population of 1,000 to 20,000"
  );

  const city5 = new City(5, "Large", 51.0447, "114.0719W", 80000);
...
test("check createCity method", () => {
  ...
  city.createCity(1, "Calgary", 51.0447, "114.0719 W", 1285711);
...
test("check whichSphere method", () => {
  ...
  city2.createCity(2, "Cordoba", -31.4201, "64.1888 W", 1391000);
